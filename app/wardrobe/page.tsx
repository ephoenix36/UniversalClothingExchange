...
export default function WardrobePage() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-[#f9f7f4] via-[#faf8f6] to-[#f2ede6]">
			{/* Header */}
			...
			<div className="max-w-7xl mx-auto px-4 py-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
					<div className="p-4 rounded-lg border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
						<div className="flex items-center justify-between">
							<div>
								<p className="text-sm text-gray-600">Total Items</p>
								<p className="text-2xl font-bold mt-1 text-gray-900">{stats.totalItems}</p>
							</div>
							<Package className="h-8 w-8 text-[#4a8a62] opacity-80" />
						</div>
					</div>
					<div className="p-4 rounded-lg border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
						<div className="flex items-center justify-between">
							...
							<Repeat className="h-8 w-8 text-green-600 opacity-80" />
						</div>
					</div>
					<div className="p-4 rounded-lg border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
						<div className="flex items-center justify-between">
					...
					<div className="p-4 rounded-lg border bg-white/80 backdrop-blur-sm shadow-sm hover:shadow-md transition-shadow">
						<div className="flex items-center justify-between">
							<div>
								...
								<p className="text-2xl font-bold mt-1 text-gray-900">{stats.totalSwaps}</p>
							</div>
							<Repeat className="h-8 w-8 text-[#d98960] opacity-80" />
						</div>
					</div>
				</div>
