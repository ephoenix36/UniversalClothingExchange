...
<p className="body-lg text-muted-foreground">Manage all your clothing exchange requests</p>
			...
			<Card className="card-spacing text-center py-16 border-2 border-dashed border-[#dcd6cc] hover:border-[#4a8a62]/50 transition-colors">
				...
				<CardDescription className="body-lg mb-8 max-w-md mx-auto">Start browsing items to request your first swap!</CardDescription>
				<Link href="/discover">
					<Button size="lg" className="btn-touch-target shadow-lg hover:shadow-xl transition-shadow">Browse Items</Button>
				</Link>
			</Card>
</div>
